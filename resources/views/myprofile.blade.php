...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-5 mt-6" x-data="{ showEditModal: false, editingRecipe: null }">
        ...
        <div>
            ...
            <div class="flex justify-end mt-6">
                <button @click="editingRecipe.editing = true"
                    class="bg-black text-white px-4 py-2 rounded hover:bg-gray-800">Edit</button>
            </div>
        </div>
    </template>
